...
The same AES-256-CBC key that is compiled into the Android app is used here.
Update KEY_BYTES below if you ever change the key in CryptoHelper.kt.
"""
...
# ----------------------------------------------------------------
# Must match CryptoHelper.kt — p1() + p2() + p3() + p4()
# ----------------------------------------------------------------
KEY_BYTES = bytes([
...
def main():
    parser = argparse.ArgumentParser(description="Generate a verifysphere:// deep-link")
